    ...
    if(message.channel.nsfw) {
        ...
        if(!argContainsBannedTags) {
            ...
            request.get('https://konachan.com/post.json', {
                ...
                if(!error && response.statusCode === 200) {
                    ...
                    let embed = new Discord.RichEmbed()
                        .setTitle('Konachan.com random image')
                        .addField('ID:',json[index].id)
                        .addField('Tags:',json[index].tags)
                        .addField('Link:','https://konachan.com/post/show/' + json[index].id)
                    ...
                    //Building and sending an embedded message.
                    let embed = new Discord.RichEmbed()
                        .setTitle('Konachan command:')
                        .setColor('DARK_RED')
                        .addField('Error:','Could\'t connect to Konachan.com!')
            ...
            let embed = new Discord.RichEmbed()
                .setTitle('Konachan command:')
                .setColor('DARK_RED')
                .addField('Error:','This request to Konachan.com contains banned tags!')
